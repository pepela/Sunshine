...
public class TestDb extends AndroidTestCase {
    ...
    public long testLocationTable() {
        ...
        // query if you like)
        TestUtilities.validateCurrentRecord("error validating cursor", cursor, testValues);
        assertFalse("More then one record was returned", cursor.moveToNext());
    ...
    public void testWeatherTable() {
        ...
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Error valdiating cursor data", cursor, contentValues);
        // Finally, close the cursor and database
        cursor.close();
        db.close();
    }
