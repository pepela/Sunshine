package com.pepela.sunshine.sunshine.sync;
...
import com.pepela.sunshine.sunshine.MainActivity;
import com.pepela.sunshine.sunshine.R;
import com.pepela.sunshine.sunshine.Utility;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private void getWeatherDataFromJson(String forecastJsonStr, String locationSetting)
        ...
        try {
            ...
            if (cVVector.size() > 0) {
                ...
                if (Utility.areNotificationsAnabled(getContext()))
                    notifyWeather();
            }

            Log.d(LOG_TAG, "Syncing Complete. " + Integer.toString(inserted) + " Inserted");
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Cursor locationCur = getContext().getContentResolver().query(
    ...
    private void notifyWeather() {
        ...
        if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
            ...
            if (cursor.moveToFirst()) {
                ...
                mNotificationManager.notify(WEATHER_NOTIFICATION_ID, notification.build());
